<?php ob_start();?><?php $_ad2869_vars=&$this->vars;$_ad2869_old_params=&$this->old_params;$_ad2869_local_params=&$this->local_params;$_ad2869_old_vars=&$this->old_vars;$_ad2869_local_vars=&$this->local_vars;?><?php echo $this->function_setvar($this->setup_args(['name'=>'_primary','value'=>'$value','this_tag'=>'setvar'],null,$this),$this)?>
...
" value="<?php $_ad2869_old_params['_73404e']=$_ad2869_local_params;$_ad2869_old_vars['_73404e']=$_ad2869_local_vars;if($this->conditional_unless($this->setup_args(['name'=>'__col_value__','this_tag'=>'unless'],null,$this),null,$this,true,true)):?>
...
<?php endif;$_ad2869_local_params=$_ad2869_old_params['_73404e'];$_ad2869_local_vars=$_ad2869_old_vars['_73404e'];?>
"
...
" <?php $_ad2869_old_params['_dd6452']=$_ad2869_local_params;$_ad2869_old_vars['_dd6452']=$_ad2869_local_vars;if($this->conditional_if($this->setup_args(['name'=>'readonly','this_tag'=>'if'],null,$this),null,$this,true,true)):?>
readonly<?php endif;$_ad2869_local_params=$_ad2869_old_params['_dd6452'];$_ad2869_local_vars=$_ad2869_old_vars['_dd6452'];?>
>
<?php $_ad2869_old_params['_051d63']=$_ad2869_local_params;$_ad2869_old_vars['_051d63']=$_ad2869_local_vars;if($this->conditional_if($this->setup_args(['name'=>'_hint','this_tag'=>'if'],null,$this),null,$this,true,true)):?>

  <div class="ml-1">
    <?php echo $this->function_var($this->setup_args(['name'=>'_hint','this_tag'=>'var'],null,$this),$this)?>

  </div>
<?php endif;$_ad2869_local_params=$_ad2869_old_params['_051d63'];$_ad2869_local_vars=$_ad2869_old_vars['_051d63'];?>

  </div>
</div>
<div class="mb-4<?php $_ad2869_old_params['_97ab19']=$_ad2869_local_params;$_ad2869_old_vars['_97ab19']=$_ad2869_local_vars;if($this->conditional_ifinarray($this->setup_args(['array'=>'display_options','value'=>'text','this_tag'=>'ifinarray'],null,$this),null,$this,true,true)):?>
 hidden<?php endif;$_ad2869_local_params=$_ad2869_old_params['_97ab19'];$_ad2869_local_vars=$_ad2869_old_vars['_97ab19'];?>
" id="entry-primary-permalink">
  ...
  <?php $_ad2869_old_params['_148268']=$_ad2869_local_params;$_ad2869_old_vars['_148268']=$_ad2869_local_vars;if($this->conditional_if($this->setup_args(['name'=>'request.workspace_id','this_tag'=>'if'],null,$this),null,$this,true,true)):?>

    <?php $_ad2869_old_params['_07c978']=$_ad2869_local_params;$_ad2869_old_vars['_07c978']=$_ad2869_local_vars;if($this->conditional_if($this->setup_args(['name'=>'workspace_link_url','this_tag'=>'if'],null,$this),null,$this,true,true)):?>
    ...
    <?php endif;$_ad2869_local_params=$_ad2869_old_params['_07c978'];$_ad2869_local_vars=$_ad2869_old_vars['_07c978'];?>

  <?php else:?>

    <?php $_ad2869_old_params['_ec2069']=$_ad2869_local_params;$_ad2869_old_vars['_ec2069']=$_ad2869_local_vars;if($this->conditional_if($this->setup_args(['name'=>'link_url','this_tag'=>'if'],null,$this),null,$this,true,true)):?>
    ...
    <?php endif;$_ad2869_local_params=$_ad2869_old_params['_ec2069'];$_ad2869_local_vars=$_ad2869_old_vars['_ec2069'];?>

  <?php endif;$_ad2869_local_params=$_ad2869_old_params['_148268'];$_ad2869_local_vars=$_ad2869_old_vars['_148268'];?>

  <?php $_ad2869_old_params['_e22d81']=$_ad2869_local_params;$_ad2869_old_vars['_e22d81']=$_ad2869_local_vars;if($this->conditional_if($this->setup_args(['name'=>'permalink','this_tag'=>'if'],null,$this),null,$this,true,true)):?>
...
"></i></button>
<?php $_ad2869_old_params['_1d580b']=$_ad2869_local_params;$_ad2869_old_vars['_1d580b']=$_ad2869_local_vars;if($this->conditional_if($this->setup_args(['name'=>'_show_both','this_tag'=>'if'],null,$this),null,$this,true,true)):?>
...
"></i></button>
<?php endif;$_ad2869_local_params=$_ad2869_old_params['_1d580b'];$_ad2869_local_vars=$_ad2869_old_vars['_1d580b'];?>

  </div>
  <input type="hidden" name="__permalink" id="__permalink" value="<?php $_ad2869_old_params['_5b18dd']=$_ad2869_local_params;$_ad2869_old_vars['_5b18dd']=$_ad2869_local_vars;if($this->conditional_if($this->setup_args(['name'=>'_show_both','this_tag'=>'if'],null,$this),null,$this,true,true)):?>
...
<?php endif;$_ad2869_local_params=$_ad2869_old_params['_5b18dd'];$_ad2869_local_vars=$_ad2869_old_vars['_5b18dd'];?>
">
<?php $_ad2869_old_params['_edfd6c']=$_ad2869_local_params;$_ad2869_old_vars['_edfd6c']=$_ad2869_local_vars;if($this->conditional_if($this->setup_args(['name'=>'_show_both','this_tag'=>'if'],null,$this),null,$this,true,true)):?>
...
">
<?php endif;$_ad2869_local_params=$_ad2869_old_params['_edfd6c'];$_ad2869_local_vars=$_ad2869_old_vars['_edfd6c'];?>

  <script>
  <?php $_ad2869_old_params['_6fc2c1']=$_ad2869_local_params;$_ad2869_old_vars['_6fc2c1']=$_ad2869_local_vars;if($this->conditional_if($this->setup_args(['name'=>'request.saved','this_tag'=>'if'],null,$this),null,$this,true,true)):?>
...
'
      ...
      function ( data ) {
          if( data.permalink ) {
              ...
              <?php $_ad2869_old_params['_a1cb4b']=$_ad2869_local_params;$_ad2869_old_vars['_a1cb4b']=$_ad2869_local_vars;if($this->conditional_unless($this->setup_args(['name'=>'_show_both','this_tag'=>'unless'],null,$this),null,$this,true,true)):?>

              if ( data.view_link ) {
                  $('#__permalink').val( data.view_link );
              }
              <?php endif;$_ad2869_local_params=$_ad2869_old_params['_a1cb4b'];$_ad2869_local_vars=$_ad2869_old_vars['_a1cb4b'];?>
...
' );
  ...
  <?php endif;$_ad2869_local_params=$_ad2869_old_params['_6fc2c1'];$_ad2869_local_vars=$_ad2869_old_vars['_6fc2c1'];?>
  ...
  <?php endif;$_ad2869_local_params=$_ad2869_old_params['_e22d81'];$_ad2869_local_vars=$_ad2869_old_vars['_e22d81'];?>

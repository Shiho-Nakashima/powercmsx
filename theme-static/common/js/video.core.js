...
(function (global, factory) {
  ...
  *         The evented object we are validating for
  ...
  BoxPosition.prototype.toCSSCompatValues = function (reference, cue) {
    var top = this.top - reference.top; // console.log(`top ${top}`);
  ...
  function moveBoxToLinePosition(window, styleBox, containerBox, boxPositions) {
    ...
    var axis = []; // If we have a line number to align the cue to.
  ...
  var FONT_STYLE = "Noto Sans JP, sans-serif"; // var CUE_BACKGROUND_PADDING = "1.5%";

  var CUE_BACKGROUND_PADDING = ""; // Runs the processing model over the cues and regions passed to it.
  ...
  WebVTT.processCues = function (window, cues, overlay) {
    ...
    var boxPositions = [];
    var containerBox = BoxPosition.getSimpleBoxPosition(paddedOverlay); // console.log(paddedOverlay);
  ...
  createCommonjsModule(function (module) {
    (function () {
      var vjsUtil = {
         ...
         */
        setVTT: function setVTT(player, url) {
          ...
          if (url.captions) {
            ...
            var trackElement = player.addRemoteTextTrack(captionOption, true);
            trackElement.addEventListener('load', function () {
              var tracks = player.remoteTextTracks();

              for (var i = -1, l = tracks.length; ++i < l;) {
                var track = tracks[i];
                track.mode = 'showing';
              }
            });
         ...
         * @param {object} player videojs playerインスタンス
         */
        removeVTT: function removeVTT(player) {
          var tracks = player.remoteTextTracks();
         ...
         * @param {object} player videojs playerインスタンス
         */
        refreshVTT: function refreshVTT(player) {
          var tracks = player.remoteTextTracks();
  ...
  var darkGray = '#222';
  var lightGray = '#ccc'; // const fontMap = {
  /**
    ...
    */
    ...
    _proto.updateDisplayState = function updateDisplayState(track) {
      ...
      while (i--) {
        ...
        var cueDiv = cue.displayState; // if (overrides.color) {
